return {
	...
	lore_text_1 = {
		...
		ru = "Это 41-е тысячелетие. В мрачной тьме далекого будущего есть только война. Император Человечества ведет постоянную битву, чтобы защитить человечество от ужасов космоса.",
	},
	lore_text_2 = {
	...
	lore_text_3 = {
		...
		ru = "\"Хаос претендует на небрежных или неполноценных. Истинный человек может отстраниться от его объятий, если он стоит твердо и облачает свою душу в доспехи презрения.\" - Рейвенор, Дэн Абнетт",
	},
	lore_text_4 = {
	...
	lore_text_10 = {
		...
		ru = "Абаддону Разорителю пришлось обрушить чрезвычайно большую космическую крепость, Крепость Блэкстоун, на Кадию Мир-крепость, чтобы наконец победить ее.",
	},
	lore_text_11 = {
	...
	ogryn_lore_2 = {
		...
		ru = "Огринские Потрошители должны быть оснащены ограничителями очереди, чтобы огрины не стреляли непрерывно... тридцать солнечных секунд шумного удовольствия могут легко оставить этих нелюдей без боеприпасов еще до того, как битва начнется.",
	},
	ogryn_lore_3 = {
	...
	ogryn_lore_5 = {
		...
		ru = "Говорят, что огрин еще менее разумен, чем некоторые орки. Однако правда в том, что их интеллект на самом деле не атрофировался, а стал гораздо более сосредоточенным на таких вещах, как выживание. В результате гены, обеспечивающие экстрасенсорные способности, неизвестны среди огринов.",
	},
	ogryn_lore_6 = {
	...
	ogryn_lore_13 = {
		...
		ru = "\"Вот я знач спрашиваю сибя, шо бы сделал полковник Стрэкер? Эт легко, грю, он наэрн кричал бы на миня: Какого я тута стою и не крошу всё вокруг сас маими братанами. Кароч так я и сделал. Они мне даж дали во, блистящую медаль, када я закончил.\" - Специалист Нифт, Костоголовый первого класса, говорящий откровенно о своем повышении.",
	},
	ogryn_lore_14 = {
	...
	ogryn_lore_17 = {
		...
		ru = "Несмотря на свой интеллект, Костоголовые огрины от природы обладают многими качествами, определяющими хорошего лидера. Они, как правило, целеустремленные личности, упрямые до отказа и не желающие отступать или признавать поражение.",
	},
	ogryn_lore_18 = {
	...
	pos_text_9 = {
		...
		ru = "СОВЕТ: фонари привлекают врагов. И они злят демонхостов. Выключайте их, когда хотите быть скрытным.",
	},
	pos_text_10 = {
	...
	pos_text_20 = {
		...
		ru = "СОВЕТ: ЗАЛП - это очередь из нескольких выстрелов. Новый залп можно сделать примерно через секунду без стрельбы.",
	},
	pos_text_21 = {
		...
		ru = "СОВЕТ: Осторожно, поднятие ГРИМУАРА нанесет вам урон. Также ваша команда будет медленно терять здоровье при переноске гримуаров из-за порчи.",
	},
	pos_text_22 = {
		en = "HINT: Using a GRIMOIRE in your inventory will cause it to disappear. You'll also stop taking corruption damage from it.",
		ru = "СОВЕТ: Использование ГРИМУАРА в ваших руках приведет к его исчезновению и вы перестанете получать от него порчу.",
	},
	pos_text_23 = {
		en = "HINT: Weapons fire from enemies will only stagger you once they break through your toughness!",
		ru = "СОВЕТ: Стрельба из оружия врагов выведет вас из равновесия только после того, как они преодолеют вашу стойкость!",
	},
	pos_text_24 = {
		...
		ru = "СОВЕТ: Ваш оперативник будет автоматически блокировать атаки на 360 градусов, при воскрешении павших товарищей по команде. Не забудьте защитить их, как только они встанут!",
	},
	pos_text_25 = {
		...
		ru = "СОВЕТ: Выносливость перезаряжается со стандартной скоростью - 1 полоска в секунду. За исключением Проповедника, у которого пассивный бонус к скорости восстановления выносливости составляет около 30 процентов.",
	},
	pos_text_27 = {
	...
	pos_text_28 = {
		...
		ru = "СОВЕТ: Экипированное оружие может повлиять на вашу скорость передвижения. При использовании большого оружия, вы замедлитесь, а маленькое оружие сделает вас более подвижным.",
	},
	pos_text_29 = {
		en = "HINT: Using your Combat Ability as Psyker when you are exploding from peril will stop you from exploding.",
		ru = "СОВЕТ: Использование Боевой способности псайкера, предотвратит взрыв, при превышении вами уровня опасности.",
	},
	pos_text_30 = {
	...
	pos_text_31 = {
		...
		ru = "СОВЕТ: Если ваше оружие ближнего боя не имеет благословения Выпад, то долгая зарядка тяжелой атаки не увеличит урон.",
	},
	pos_text_32 = {
	...
	pos_text_35 = {
		...
		ru = "СОВЕТ: Вы можете навестись на конкретных врагов способностью Проповедника \"Кара для нечестивых\", удерживая нажатой клавишу способности(F). Выбранный враг получит слабую желтую ауру.",
	},
	pos_text_36 = {
	...
	pos_text_41 = {
		...
		ru = "СОВЕТ: Гримуары по-прежнему учитываются, как взятые, в контрактах сира Мелка, если вы их выбросите, но вы потеряете награду опыта.",
	},
	pos_text_42 = {
	...
	pos_text_43 = {
		...
		ru = "СОВЕТ: Следующие атаки ближнего боя невозможно заблокировать: удар из-за головы Дробителя, сильный замах в ближнем бою \"Цели убийства\" и удар левой рукой Чумного Огрина из-за головы.",
	},
	pos_text_44 = {
		en = "HINT: The Mauler two-handed slam can be blocked, but will break your Toughness anyway.",
		ru = "СОВЕТ: Двуручный удар Скаба-палача можно заблокировать, но он все равно сломает вашу Стойкость.",
	},
	pos_text_45 = {
	...
	pos_text_46 = {
		...
		ru = "СОВЕТ: Демонхост всегда сначала атакуют человека, который его разбудил первым, а затем того, кто нанес ему наибольший урон.",
	},
	pos_text_47 = {
	...
	pos_text_49 = {
		...
		ru = "СОВЕТ: Вы можете сокращать залпы очередей, щелкая правой кнопкой мыши.",
	},
	pos_text_50 = {
		en = "HINT: You can dodge greater distances by simultaneously sliding.",
		ru = "СОВЕТ: Вы можете уклоняться на большие расстояния, используя одновременно подкат.",
	},
	pos_text_51 = {
	...
	pos_text_52 = {
		...
		ru = "СОВЕТ: Болтеры и плазмоганы могут стрелять сквозь тонкие укрытия. Они также пробьют защиту Бастиона.",
	},
	pos_text_53 = {
	...
	pos_text_55 = {
		...
		ru = "СОВЕТ: Максимальный рейтинг, которого могут достичь базовые характеристики оружия, составляет 380.",
	},
	pos_text_56 = {
		en = "HINT: If a melee weapon has a special attack, combining it with a heavy attack improves its damage.",
		ru = "СОВЕТ: Если оружие ближнего боя имеет спецатаку, сочетание её с тяжелой атакой увеличивает урон.",
	},
	pos_text_57 = {
