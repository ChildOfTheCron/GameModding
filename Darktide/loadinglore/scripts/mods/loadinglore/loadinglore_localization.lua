return {
	...
	lore_text_3 = {
		...
		ru = "\"Хаос претендует на небрежных или неполноценных. Истинный человек может отстраниться от его объятий, если он стоит твёрдо и облачает свою душу в доспехи презрения.\" - Рейвенор, Дэн Абнетт",
	},
	lore_text_4 = {
	...
	lore_text_5 = {
		...
		ru = "Первым признаком приближающегося флота Тиранидов является невозможность отправлять или получать сообщения в искривлённом пространстве в пределах системы…",
	},
	lore_text_6 = {
	...
	lore_text_7 = {
		...
		ru = "Скабовые Враги - это полк Имперской Гвардии под названием Моэбийский 6-й, который перешёл на сторону изменников.",
	},
	lore_text_8 = {
		en = "The Emperor has his own bodyguards called the Adeptus Custodes, more powerful than even Space Marines.",
		ru = "У Императора есть свои личные телохранители, называемые Адептус Кустодес, более мощные, чем даже Космические Десантники.",
	},
	lore_text_9 = {
		...
		ru = "Лишь немногие из человеческого населения являются \"пустыми\", также называемыми \"нулями\", которые сводят на нет варп вокруг себя. Псайкерам больно находиться рядом с ними.",
	},
	lore_text_10 = {
		...
		ru = "Абаддону Разорителю пришлось обрушить чрезвычайно большую космическую крепость, Крепость Блэкстоун, на Кадию Мир-крепость, чтобы наконец победить её.",
	},
	lore_text_11 = {
		...
		ru = "Император Человечества — это гниющая туша, терзаемая силой Темной Эры Технологий. Он Повелитель Мертвецов, ради которого каждый день приносятся в жертву тысячи душ, чтобы Он никогда не умер по-настоящему.",
	},
	ogryn_lore_1 = {
		...
		ru = "Огрины (Homo sapiens gigantus) — огромные и физически сильные недолюди-мутанты, подвид Человечества, нанятые Империумом Человечества в качестве штурмовиков в спецподразделение Милитарум Ауксилия в Имперской Гвардии.",
	},
	ogryn_lore_2 = {
		...
		ru = "Огринские Потрошители должны быть оснащены ограничителями очереди, чтобы огрины не стреляли непрерывно... тридцать солнечных секунд шумного удовольствия могут легко оставить этих нелюдей без боеприпасов ещё до того, как битва начнется.",
	},
	ogryn_lore_3 = {
		...
		ru = "Огрины происходят с ряда холодных и безжизненных планет по всей галактике, которые обладают высокой гравитацией, таких как Анарк Зета, поэтому они выглядят больше, тяжелее и массивнее по сравнению с обычными людьми.",
	},
	ogryn_lore_4 = {
		...
		ru = "Предки огринов, происходящие с холодных, безжизненных, высокогравитационных тюремных планет, заселённых за многие тысячелетия до основания Империи Человечества, были когда-то обычными людьми ещё во времена Тёмного Века Технологий.",
	},
	ogryn_lore_5 = {
	...
	ogryn_lore_7 = {
		...
		ru = "Нотариальная Палата Десятины, подп. Планетарной Переписи (Нелюди) — подразделение Адептус Администратум, отвечающее за классификацию и признание стабильных штаммов нелюдей в Империуме.",
	},
	ogryn_lore_8 = {
		...
		ru = "В настоящее время официально признаны семь различных типов стабильных штаммов недолюдей: Альфа, Тета, Тип IV, Тип VIIA, H.S. gigantus gigantus, H.S. gigantus cranopus и загадочные Серые Огрины.",
	},
	ogryn_lore_9 = {
	...
	ogryn_lore_12 = {
		...
		ru = "Огрины официально служат в Милитарум Ауксилия, специализированном подразделении Имперской Гвардии, которое включает в себя большинство подразделений нелюдей, нанятых Империумом, включая огринов и ратлингов.",
	},
	ogryn_lore_13 = {
	...
	ogryn_lore_14 = {
		...
		ru = "Костоголовые часто являются мозгом своих отрядов, другие огрины считают их лидерами, как на поле боя, так и за его пределами.",
	},
	ogryn_lore_15 = {
		...
		ru = "В то время как средний огрин неуклюж, Костоголовые гораздо более координированы и способны владеть оружием с удивительной ловкостью, хотя присущую им неуклюжесть никогда нельзя полностью искоренить.",
	},
	ogryn_lore_16 = {
	...
	ogryn_lore_20 = {
		...
		ru = "Костоголовые способны понимать более сложные приказы, поэтому их часто назначают командирами отряда обычных огринов без аугментов.",
	},
	...
	pos_text_4 = {
		...
		ru = "Отродье Нургла считает тебя достойным объятий! - Wobin",
	},
	pos_text_5 = {
	...
	pos_text_9 = {
		...
		ru = "СОВЕТ: фонари привлекают врагов. И они злят демонхостов. Выключайте их, когда хотите быть скрытными.",
	},
	pos_text_10 = {
		en = "HINT: Be sure to tag enemies so your team is aware of them. Targets are easily lost in the din of battle!",
		ru = "СОВЕТ: обязательно помечайте врагов, чтобы ваша команда знала о них. Цели легко теряются в пылу боя!",
	},
	pos_text_11 = {
		...
		ru = "СОВЕТ: всегда полезно иметь план, прежде чем вступать в бой с Демонхостом. Иначе вся ваша команда будет разорвана в клочья.",
	},
	pos_text_12 = {
		en = "HINT: 41st Millenium is tough going - so look out for one another!",
		ru = "СОВЕТ: В 41-ом тысячелетии тяжело — берегите друг друга!",
	},
	pos_text_13 = {
		en = "HINT: The POWER stat affects the amount of damage you put out, while also reducing the damage you take during battle.",
		ru = "СОВЕТ: показатель СИЛА влияет на количество наносимого вами урона, а также снижает урон, который вы получаете во время боя.",
	},
	pos_text_14 = {
		...
		ru = "СОВЕТ: обязательно помечайте ресурсы для своей команды! И подумайте о том, чтобы оставить патроны для Ветеранов, обычно им они нужны гораздо больше, чем другим классам!",
	},
	pos_text_15 = {
	...
	pos_text_16 = {
		...
		ru = "СОВЕТ: УДАРНАЯ МАССА — это характеристика, определяющая, количество врагов, которых вы сможете ПОРАЗИТЬ одним ударом в ближнем бою. Игнорирование вражеской ударной массы означает, что для вашего оружия ближнего боя будет увеличен или вовсе убран лимит на количество врагов поражённых при ударе. Это очень полезная характеристика для зачистки орд.",
	},
	pos_text_17 = {
		en = "HINT: The MOBILITY stat increases your operatives movement abilities. For example dodge distance, slide distance etc.",
		ru = "СОВЕТ: показатель МОБИЛЬНОСТЬ увеличивает возможности передвижения ваших оперативников. Например, расстояние уклонения, расстояние скольжения и т.д.",
	},
	pos_text_18 = {
		en = "HINT: The FINESSE stat increases damage on hits that target enemy weakspots.",
		ru = "СОВЕТ: характеристика ТОЧНОСТЬ увеличивает урон от ударов по слабым местам врага.",
	},
	pos_text_19 = {
		en = "HINT: The RENDING stat increases your weapons armour penetration.",
		ru = "СОВЕТ: показатель ТЕРЗАНИЕ увеличивает пробиваемость брони вашего оружия.",
	},
	pos_text_20 = {
	...
	pos_text_22 = {
		...
		ru = "СОВЕТ: Использование ГРИМУАРА в ваших руках приведёт к его исчезновению и вы перестанете получать от него порчу.",
	},
	pos_text_23 = {
	...
	pos_text_24 = {
		...
		ru = "СОВЕТ: Ваш оперативник будет автоматически блокировать все атаки вокруг, при воскрешении павших товарищей по команде. Не забудьте прикрыть их, когда они встают!",
	},
	pos_text_25 = {
		...
		ru = "СОВЕТ: У всех классов выносливость перезаряжается со стандартной скоростью - 1 полоска в секунду, за исключением Проповедника, у которого пассивная прибавка к скорости восстановления выносливости составляет около 30 процентов.",
	},
	pos_text_27 = {
	...
	pos_text_28 = {
		...
		ru = "СОВЕТ: Экипированное оружие может повлиять на вашу скорость передвижения. При использовании большого тяжёлого оружия, вы замедлитесь, а маленькое оружие сохранит вашу подвижность.",
	},
	pos_text_29 = {
	...
	pos_text_31 = {
		...
		ru = "СОВЕТ: Если ваше оружие ближнего боя не имеет благословения \"Выпад\", то долгая зарядка тяжёлой атаки не увеличит урон.",
	},
	pos_text_32 = {
	...
	pos_text_33 = {
		...
		ru = "СОВЕТ: НЕ СТРЕЛЯЙТЕ в Чумного взрывуна, если вы видите, что товарищ по команде бежит к нему!",
	},
	pos_text_34 = {
		en = "HINT: Your Psyker is headpopping Poxwalkers to keep their warp charges up, quit shooting them.",
		ru = "СОВЕТ: Ваш псайкер взрывает головы чумным ходокам, чтобы поддерживать варп-заряды, перестаньте стрелять в них!",
	},
	pos_text_35 = {
		...
		ru = "СОВЕТ: Вы можете навестись на конкретного врага способностью Проповедника \"Кара для нечестивых\", удерживая нажатой клавишу способности(F). У выбранного врага появится слабая жёлтая аура.",
	},
	pos_text_36 = {
	...
	pos_text_41 = {
		...
		ru = "СОВЕТ: Гримуары по-прежнему учитываются, как взятые, в контрактах сира Мелка, если вы их выбросите, но тогда вы потеряете награду опыта.",
	},
	pos_text_42 = {
		en = "HINT: Scriptures have a very faint audio cue, sounding a bit like hissing or whispering.",
		ru = "СОВЕТ: Писания имеют очень слабый звуковой сигнал, немного похожий на шипение или шёпот.",
	},
	pos_text_43 = {
	...
	pos_text_44 = {
		...
		ru = "СОВЕТ: Двуручный удар Скаба-палача можно заблокировать, но он всё равно сломает вашу Стойкость.",
	},
	pos_text_45 = {
	...
	pos_text_46 = {
		...
		ru = "СОВЕТ: Демонхост всегда сначала атакует человека, который его разбудил первым, а затем того, кто нанёс ему наибольший урон.",
	},
	pos_text_47 = {
		...
		ru = "СОВЕТ: Демонхост всегда уходит, когда умирают два члена группы, независимо от того, убил их сам демонхост или нет.",
	},
	pos_text_48 = {
	...
	pos_text_50 = {
		...
		ru = "СОВЕТ: Вы можете уклоняться на большие расстояния, используя одновременно с уклонением подкат.",
	},
	pos_text_51 = {
	...
	fun_text_3 = {
		...
		ru = "\"Фрак это! Моя душа принадлежит мне и я оставлю её себе!\" - Комиссар Киафас Каин",
	},
	fun_text_4 = {
